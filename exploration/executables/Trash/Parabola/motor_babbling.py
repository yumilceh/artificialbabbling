...
if __name__ == '__main__':
    ...
    from exploration.algorithm.AlgorithmRandom import Algorithm_Random as Algorithm
    ...
    # fig3,ax3=simulation_data.plot_2D(fig3,ax3,'action', 0, 'sensor', 0,"or")
    # fig3, ax3 = validation_valSet_data.plot_2D(fig3,ax3,'action', 0, 'sensor', 0,"ob")
    ...
    # fig4,ax4=simulation_data.plot_2D(fig4,ax4,'action', 1, 'sensor', 1,"or")
    # fig4, ax4 = validation_valSet_data.plot_2D(fig4,ax4,'action', 1, 'sensor', 1,"ob")
