...
directory = 'diva_experiment_thesis_chap_6_social_toshi_final'
...
def sim_agent(ops,idx):
    ...
    evaluation_sim.load_eval_dataset('../../systems/datasets/german_dataset_somato.h5',name="German_Vowels")
...
if __name__ == '__main__':
    ...
    vowel_units = [323]#323,223,123,50]

    groups2 = itertools.product(random_seeds, mode_ops, social_slopes, vowel_units)
