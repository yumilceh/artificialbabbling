...
from ..data.data import SimulationData_v2, load_sim_h5_v2
...
class DatasetGenerator(object):
    ...
    def __init__(self,  system,  
        ...
        self.data = SimulationData_v2(self.system)
...
def reduce_file_dataset(self, system, min_dist, file_name=None):
    ...
    data_tmp = load_sim_h5_v2(file_name, system)
...
def reduce_(data, min_distance, system):
    ...
    somato_data_as_matrix = data.somato.data.as_matrix()
    ...
    for i in range(sensor_data_as_matrix.shape[0]):
        ...
        for j in reversed(range(i+1,sensor_data_as_matrix.shape[0])):
            ...
            if distance_ij < min_distance:
                ...
                somato_data_as_matrix = np.delete(somato_data_as_matrix, j, 0)
