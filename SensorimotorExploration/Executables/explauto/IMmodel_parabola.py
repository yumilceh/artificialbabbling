...
if __name__ == '__main__':
    ...
    from SensorimotorExploration.Models.Sensorimotor.ExplautoSM import ExplautoSM
    ...
    from SensorimotorExploration.Algorithm.utils.competence_funcs import comp_Moulin2013_expl as competence
