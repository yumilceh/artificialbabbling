...
if __name__ == '__main__' and file_conv:
    import sys
    sys.path.append("../../")  # To guarantee that the  DataManager path is available to read the  npy file
    # Experiment report and audios
...
if __name__ == '__main__' and data_set_vowels:
    ...
    for vowel1 in english_vowels_keys:
        ...
        system.set_action(m)
        system.executeMotorCommand()
        vowels_data_set.appendData(system)
    ...
    vowels_data_set.saveData("vowels_dataset_1.h5")
