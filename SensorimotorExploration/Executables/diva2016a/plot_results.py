...
def show_results(system, simulation, val_data):
    ...
    plt.hold(True)
    fig1, ax1 = simulation.data.plotSimulatedData2D(fig1, ax1, 'sensor', 3, 'sensor', 4, ".r")
    ...
    plt.hold(True)
    fig3, ax3 = val_data.plotSimulatedData2D(fig3, ax3, 'sensor_goal', 3, 'sensor_goal', 4, "xb")
    fig3, ax3 = val_data.plotSimulatedData2D(fig3, ax3, 'sensor', 0, 'sensor', 1, ".b")
    fig3, ax3 = val_data.plotSimulatedData2D(fig3, ax3, 'sensor', 3, 'sensor', 4, ".r")
    ...
    simulation.data.plotTemporalSimulatedData(fig5,ax5,'competence',0,'b',moving_average=10)
    simulation.data.plotTemporalSimulatedData(fig5,ax5,'competence',0,'r',moving_average=200)
    ...
    plt.hold(True)
    fig6, ax6 = simulation.data.plotSimulatedData2D(fig6, ax6, 'sensor_goal', 3, 'sensor_goal', 4, ".r")
