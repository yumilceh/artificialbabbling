...
if __name__ == '__main__':
    ...
    h1,ax1=validation_trainSet_data.plotTemporalSimulatedData(h1,ax1,'competence', 0,"r",moving_average=2000)
    ...
    h2,ax2=validation_valSet_data.plotTemporalSimulatedData(h2,ax2,'competence', 0,"r",moving_average=2000)
